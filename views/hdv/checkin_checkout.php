                ...
                <div class="p-4 timeline-container">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <div class="time-badge"><i class="bi bi-clock me-1"></i><?= date('H:i d/m', strtotime($row['CreatedAt'])) ?></div>
                            <div>
                                <a href="?act=hdv-checkin-delete&id=<?= $tourId ?>&entry_id=<?= $row['CheckInOutID'] ?>"

            ...
            <?php if (!empty($tour) && is_array($tour)): ?>
                <div class="row g-4">
                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <!-- Thông tin đoàn -->
                        <div class="card shadow-sm p-4 tour-desc-card mt-4">
                            <h4 class="card-title mb-3 d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-people"></i> Thông tin đoàn</span>
                                <a href="<?= BASE_URL ?>?act=asm-detail-hdv" class="btn btn-sm btn-outline-primary">
                                    Chi tiết
                                </a>
                            </h4>
                        </div>
...
<style>
    ...
    .team-info-list .list-group-item {
        padding: 12px 0;
        font-size: 1rem;
        color: #333;
        border: none;
    ...
    .team-info-list .list-group-item i {
        font-size: 1.1rem;
        margin-right: 6px;
    }

    /* Badge trạng thái */
    .team-info-list .badge {
        border-radius: 8px;
        font-size: 0.85rem;

                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                    ...
                    <div class="position-relative">
                        ...
                        <img src="<?= htmlspecialchars($tour['Image']) ?>" class="w-100 object-fit-cover"
                            ...
                            onerror="this.onerror=null; this.src='https://via.placeholder.com/400x250?text=Loi+Anh';">
                        <?php else: ?>
                        ...
                        <span
                            class="position-absolute bottom-0 start-0 m-3 badge bg-danger shadow-sm border border-white">
                            Giảm 10%
                        </span>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="vstack gap-3">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <span class="text-secondary small text-uppercase fw-bold mt-1">
                                    <i class="bi bi-cash-stack me-2 text-success"></i>Giá tour
                                </span>
                                <div class="text-end">
                                    <?php 
                        ...
                        <div class="mt-4 pt-3 border-top d-grid gap-2">
                            <a href="<?= BASE_URL ?>?act=operate-tour&id=<?= $tour['TourID'] ?>"
                                ...
                                <i class="bi bi-gear-fill me-1"></i> Điều hành Tour
                            </a>
                            <a href="<?= BASE_URL ?>?act=booking-create&tour_id=<?= $tour['TourID'] ?>"
